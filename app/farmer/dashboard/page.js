            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="glass-card">
                  ...
                  <label className="mt-5 flex h-24 cursor-pointer items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-white/50 text-sm font-medium text-slate-500 hover:bg-white/80">{cameraFile ? cameraFile.name : 'Upload leaf image'}<input type="file" accept="image/*" capture="environment" className="sr-only" onChange={(event) => setCameraFile(event.target.files?.[0] || null)} /></label>
